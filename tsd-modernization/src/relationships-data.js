...
export const RELATIONSHIPS = {
  salons: {
    ...
    routeMetaDesc: "Custom website and AI tools for Charlotte hair salons, nail studios, and spas — booking automation, after-hours chat, missed-call recovery. Built in 2-4 weeks. Source code yours from day one; optional Managed AI keeps it running.",
    hero: {
    ...
    build: {
      ...
      sub: "Six deliverables, fixed scope, one fixed price. Source code and GitHub repo are yours from day one, with optional Managed AI to keep everything running after launch.",
      bullets: [
  ...
  "auto-shops": {
    ...
    routeMetaDesc: "Custom website and AI tools for Charlotte auto repair, body shops, and tire stores — online quote requests, service catalogs, after-hours intake. Built in 2-4 weeks. Source code yours from day one; optional Managed AI keeps it running.",
    hero: {
  ...
  restaurants: {
    ...
    routeMetaDesc: "Custom website and AI tools for Charlotte restaurants, bakeries, and food trucks — reservations, online ordering, AI chat for menu and hours. Built in 2-4 weeks. Source code yours from day one; optional Managed AI keeps it running.",
    hero: {

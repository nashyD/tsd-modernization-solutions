...
export const SERVICES = [
  {
    ...
    gallery: [
      ...
      { Icon: BoltIcon, embed: "make-flow-demo", title: "Make Automation Flow", desc: "Multi-step automation connecting a contact form to CRM, email sequences, and calendar booking." },
  ...
  },
  {
    ...
    price: "$1,500 founding rate (standard $3,000). This is the Phase I Discovery engagement of the Summer 2026 cohort. Money-back if we can't find $25K of opportunities. Also included in the $5,000 Founding Partnership.",
    videos: [

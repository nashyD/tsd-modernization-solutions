...
const STEPS = [
  ...
  { num: "04", title: "Launch, your way", desc: "Go live Managed, where we host it and make every change for you, just text us, or Owned, where the source code, credentials, and deployment are yours with documentation and a live training session.", detail: "Managed plans from $49/mo (site) or $73/mo (AI) keep it sharp after launch. Cancel anytime." },
];

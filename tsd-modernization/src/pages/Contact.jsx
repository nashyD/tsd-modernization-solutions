...
function FAQSection() {
  const faqs = [
    ...
    { q: "What happens after my project is done?", a: "Every project comes with comprehensive handoff documentation, video tutorials, and a 2-week support window. You'll be able to manage everything independently. For ongoing support, our monthly retainer keeps us available for updates and troubleshooting." },
    { q: "Why are your prices so much lower than agencies?", a: "We're a lean team of three founders with minimal overhead. We're also deliberately underpricing to build our portfolio and earn client trust. You get the same quality at 3-5x less." },

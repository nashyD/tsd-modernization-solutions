 ...
 *
 * The Vercel function bundler picks this up automatically because it's
 * imported by api/chat-transcript.js. The TSD logo PNG it CID-embeds
 * lives at content/email-assets/tsd-ms-logo.png and is bundled via
 * vercel.json's `includeFiles` config.
 *
...
// Logo loaded once at module init. Lives at content/email-assets/...
// because Vercel's includeFiles already bundles content/** for the chat
// agent's knowledge file — same bundle, no extra config to remember.

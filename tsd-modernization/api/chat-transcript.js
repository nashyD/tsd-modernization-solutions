 ...
 * (pagehide) or closes the chat widget, builds a TSD-branded HTML
 * email matching the voice receptionist's transcript format, and
 * sends it to the founders via Gmail SMTP.
 *
